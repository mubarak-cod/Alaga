  ...
  return (
    <section className="whyme-container">
      <div className="whyme-text">
        <h2>Why Choose Me?</h2>
        <p>
          If you thought planning an event was hard, try keeping your guests off of their phones and engaged throughout the event! How exhausting, right? Well, leave it to the LIT MC Jessica Sinclair. Sinclair Master of Ceremonies Inc is an award-winning event hosting company located on Long Island, New York.
        </p>
        <p>
          Sinclair Master of Ceremonies Inc is a one-of-a-kind Master of Ceremony Service. I provide events with excellent day-of coordination & facilitation, executing your event with style and grace.
        </p>
        <p>
